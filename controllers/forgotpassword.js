...
try{
  ...
  const user = await User.findOne({mail:mail});
    const forgotPwd = new Forgotpassword({userId:user._id,expiresby: current });
    forgotPwd._id = id;
 ...
 const msg = {
  to: mail, 
  from: 'deepi.sakthivel@gmail.com',
  subject: 'Reset Password Link',
  text: 'Click on this link to reset a password',
  html: `<a href='http://3.105.195.179:3000/forgotpassword/${id}'>Reset Password Link</a>`
}
